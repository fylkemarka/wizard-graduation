...
**MVP 1** — combat loop, intent telegraph, card rewards, linear fight chain.

Roadmap:
- MVP 2: Act 1 branching map (Staff Path)
- MVP 3: Acts 2-4 (Robes / Gem / Ring) + equipment tiers
- MVP 4: Powers, relics, rest sites
- MVP 5: Five wizard schools as playable classes
