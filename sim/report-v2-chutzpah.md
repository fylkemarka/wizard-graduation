...
N = **25** runs simulated with a greedy v2 AI.

## Win rate
- **0 wins / 25** = **0.0%**
- Losses by acts-cleared: 0=25 · 1=0 · 2=0 · 3=0

## Lane outcomes
- **wit**: 0 runs · 0 wins (0.0%)
- **chutzpah**: 25 runs · 0 wins (0.0%)
...
- Runs with at least one RAGE turn: 0 / 25 (0.0%)
- Bare Knuckles casts: 0 (misfires: 0)

## Chutzpah DOUBLING DOWN (v2.25)
- Total double-down casts: 0
- Runs with at least one double-down cast: 0 / 25 (0.0%)
...
- Runs with at least one Storm Out: 0 / 25 (0.0%)

## Chutzpah HIT ME AGAIN (v2.27)
- Hit Me Again installs: 0 (runs: 0 / 25, 0.0%)
...
- v2.92 Passing Thoughts: 0 granted, 0 played
...
- "in summary," casts: 0 (runs: 0 / 25, 0.0%)
- Total capstone damage: 0
- Avg damage per cast: 0.00

## Wit INSULT VULNERABILITIES (v2.42)
- Casts that hit the rider: 0 (runs: 0 / 25, 0.0%)
- Total matched tags (capped 3/cast): 0
- Total bonus damage: 0
- Avg bonus per cast: 0.00

## Jnsq TANGENT (v2.44)
- "That reminds me," skill plays: 0 (runs: 0 / 25, 0.0%)
...
## Jnsq APOLOGY (v2.45)
- "I shouldn't have said that —" plays: 0 (runs: 0 / 25, 0.0%)
- Total HP healed: 0
- Total tray cards discarded by reset: 0
- Avg tray cards / cast: 0.00

## Jnsq WON'T SHUT UP (v2.46)
- Rider armed (soup target cast): 0 (runs: 0 / 25, 0.0%)
...
- Installs (per-combat): 0 (runs: 0 / 25, 0.0%)
...
- "...go on, I'm listening." plays: 0 (runs: 0 / 25, 0.0%)
...
- "sorry, I lost my balance" plays: 0 (runs: 0 / 25, 0.0%)
