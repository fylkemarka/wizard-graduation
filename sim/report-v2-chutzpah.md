...
## Win rate
- **5 wins / 30** = **16.7%**
- Losses by acts-cleared: 0=0 · 1=6 · 2=19 · 3=0

## Lane outcomes
- **wit**: 0 runs · 0 wins (0.0%)
- **chutzpah**: 30 runs · 5 wins (16.7%)
- **jnsq**: 0 runs · 0 wins (0.0%)

## Familiar outcomes (v2.9)
- **fam-mouse**: 5 runs · 3 wins (60.0%)
- **fam-rabbit**: 2 runs · 1 wins (50.0%)
- **fam-toad**: 5 runs · 1 wins (20.0%)
...
## Cast distribution
- Total casts: 559
- Tier 1 (COHERENT): 426 (76.2%)
- Tier 2 (RESONANT): 126 (22.5%)
- Tier 3 (DEVASTATING): 7 (1.3%)
- Holds (turn ended without cast — tray persists): 1346 (70.7%)

## Chutzpah TUNNEL VISION (v2.24)
- Total RAGE triggers: 135
- Runs with at least one RAGE turn: 28 / 30 (93.3%)
- Bare Knuckles casts: 4 (misfires: 1)

## Chutzpah DOUBLING DOWN (v2.25)
- Total double-down casts: 31
- Runs with at least one double-down cast: 11 / 30 (36.7%)
- Corner-token bills (enemy survived → -HP): 4
- HP lost to corner-tokens: 8
...
- Hit Me Again installs: 221 (runs: 27 / 30, 90.0%)
- Total recoil damage to enemies: 2909
- Enemies killed by their own recoil: 84
- Avg recoil per install: 13.2

## Chutzpah SAYING IT LOUDER (v2.29)
- "I SAID." casts: 21 (runs: 6 / 30, 20.0%)
- Avg loudCount per cast: 0.43
- Avg bonus damage per cast: 1.29
- Total bonus damage from louder: 27

## Chutzpah SMELL WEAKNESS (v2.30)
- Predator triggers (cast hit while enemy debuffed): 2 (runs: 2 / 30, 6.7%)
- Total bonus damage from predator: 10
- Avg bonus per trigger: 5.00

## Chutzpah SYNERGY CAPSTONE — "AND I'M NOT DONE." (v2.31)
- Capstone casts: 12 (runs: 3 / 30, 10.0%)
- Total capstone damage: 341
- Avg damage per capstone cast: 28.42

## Chutzpah NOT LISTENING — "Sorry — what?" SKILL (v2.33)
- Skill casts: 104 (runs: 18 / 30, 60.0%)
- Total debuff absorbs: 39
- Avg absorbs per skill cast: 0.38
...
- v2.67 chip-cast skips (HUMAN_PLAY_PROFILE-aligned): 18
- v2.90 backfire-smoother fires (3rd consecutive 1 → 2): 0
- v2.92 Passing Thoughts: 73 granted, 82 played
...
## Combat pacing
- Avg turns / combat: 4.58
- Avg damage / run: 397
- Mean final deck size: 18.6
...
## Top killer enemies
- e1-boss-thornlord (The Thornlord): 14
