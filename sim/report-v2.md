...
## Win rate
- **0 wins / 5** = **0.0%**
- Losses by acts-cleared: 0=3 · 1=1 · 2=1 · 3=0
...
## Cast distribution
- Total casts: 64
- Tier 1 (COHERENT): 59 (92.2%)
- Tier 2 (RESONANT): 5 (7.8%)
- Tier 3 (DEVASTATING): 0 (0.0%)
- Holds (turn ended without cast — tray persists): 114 (64.0%)

## Chutzpah TUNNEL VISION (v2.24)
- Total RAGE triggers: 8
- Runs with at least one RAGE turn: 2 / 5 (40.0%)
- Bare Knuckles casts: 1 (misfires: 0)
...
- Hit Me Again installs: 9 (runs: 1 / 5, 20.0%)
- Total recoil damage to enemies: 47
- Enemies killed by their own recoil: 1
- Avg recoil per install: 5.2
...
- Combats reaching LT ≥ 1: 3 (runs: 2 / 5, 40.0%)
- Avg peak LT per run (across all combats): 0.60
- Avg peak LT per threaded combat: 1.00
- Thread breaks (unblocked hit reset a non-zero meter): 1
- Thread-scaling rider triggers: 2
- Total bonus damage from thread scaling: 2
...
- v2.92 Passing Thoughts: 5 granted, 5 played
...
- Total re-fire damage: 18
- Avg damage / re-fire: 18.00
...
- "in summary," casts: 1 (runs: 1 / 5, 20.0%)
- Total capstone damage: 24
- Avg damage per cast: 24.00
...
- "...go on, I'm listening." plays: 0 (runs: 0 / 5, 0.0%)
...
## Jnsq BABBLING (v2.49)
- Installs (per-combat): 3 (runs: 1 / 5, 20.0%)
- 2nd casts fired: 0
