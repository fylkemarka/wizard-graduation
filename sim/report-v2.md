...
N = **3** runs simulated with a greedy v2 AI.
...
- Runs with at least one double-down cast: 0 / 3 (0.0%)
...
- Casts that hit the rider: 0 (runs: 0 / 3, 0.0%)
- Total matched tags (capped 3/cast): 0
- Total bonus damage: 0
- Avg bonus per cast: 0.00

## Jnsq TANGENT (v2.44)
- "That reminds me," skill plays: 0 (runs: 0 / 3, 0.0%)
...
## Jnsq APOLOGY (v2.45)
- "I shouldn't have said that —" plays: 0 (runs: 0 / 3, 0.0%)
- Total HP healed: 0
- Total tray cards discarded by reset: 0
- Avg tray cards / cast: 0.00

## Jnsq WON'T SHUT UP (v2.46)
- Rider armed (soup target cast): 0 (runs: 0 / 3, 0.0%)
...
- "sorry, I lost my balance" plays: 0 (runs: 0 / 3, 0.0%)
