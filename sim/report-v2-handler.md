...
N = **40** runs simulated with a greedy v2 AI.

## Win rate
- **0 wins / 40** = **0.0%**
- Losses by acts-cleared: 0=38 · 1=2 · 2=0 · 3=0

## Lane outcomes
- **wit**: 0 runs · 0 wins (0.0%)
- **handler**: 40 runs · 0 wins (0.0%)
...
- Handler runs: 40 · 0 wins (0.0%)
- Combats fought: 180
- Summons: 1341 · feeds: 698 · short-stays (unfed left early): 180 · combines: 30
- Combine payoff: burst 424 (avg 14.1/combine) · lifetime attacks 426 (avg 14.2/combine) · combine = 8.6% of all menagerie composure
- Menagerie composure dealt: 9896 · block generated: 3538
- Avg summons/combat: 7.45 · avg feeds/combat: 3.88
- Tactic changes: 195 · avg distinct tactics/combat: 0.75
- Special-lure animals: summons 270 · porcupine thorns dealt 668 · sloth enemy-turns skipped 62
- Activated abilities (Mime/Pigeon/Kangaroo): 62 activations
- Tactic engagement: shield 74 · rabid 24 · youth 25 · nurture 53 · feather 19

## Wit LONG THREAD (v2.34)
- Combats reaching LT ≥ 1: 0 (runs: 0 / 40, 0.0%)
...
- v2.92 Passing Thoughts: 26 granted, 0 played
...
## Jnsq APOLOGY (v2.45)
- "I shouldn't have said that —" plays: 0 (runs: 0 / 40, 0.0%)
- Total HP healed: 0
- Total tray cards discarded by reset: 0
- Avg tray cards / cast: 0.00

## Jnsq WON'T SHUT UP (v2.46)
- Rider armed (soup target cast): 0 (runs: 0 / 40, 0.0%)
...
- Installs (per-combat): 0 (runs: 0 / 40, 0.0%)
...
- "...go on, I'm listening." plays: 0 (runs: 0 / 40, 0.0%)
...
## Combat pacing
- Avg turns / combat: 8.90
- Avg damage / run: 268
- Mean final deck size: 12.2

## Archetype of winning decks

## Top killer enemies
- e2-boss-tapestry (The Tapestry Walker): 16
