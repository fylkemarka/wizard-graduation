...
## Win rate
- **0 wins / 300** = **0.0%**
- Losses by acts-cleared: 0=211 · 1=87 · 2=2 · 3=0

## Lane outcomes
- **wit**: 0 runs · 0 wins (0.0%)
- **handler**: 300 runs · 0 wins (0.0%)
- **jnsq**: 0 runs · 0 wins (0.0%)

## Familiar outcomes (v2.9)
- **fam-toad**: 30 runs · 0 wins (0.0%)
- **fam-beetle**: 30 runs · 0 wins (0.0%)
- **fam-mouse**: 33 runs · 0 wins (0.0%)
- **fam-cat**: 24 runs · 0 wins (0.0%)
- **fam-raven**: 30 runs · 0 wins (0.0%)
- **fam-snake**: 34 runs · 0 wins (0.0%)
- **fam-rabbit**: 28 runs · 0 wins (0.0%)
- **fam-hedgehog**: 34 runs · 0 wins (0.0%)
- **fam-crow**: 27 runs · 0 wins (0.0%)
- **fam-owl**: 30 runs · 0 wins (0.0%)
...
- Handler runs: 300 · 0 wins (0.0%)
- Combats fought: 1785
- Summons: 12568 · feeds: 6260 · short-stays (unfed left early): 2144 · combines: 308
- Combine payoff: burst 4396 (avg 14.3/combine) · lifetime attacks 5746 (avg 18.7/combine) · combine = 9.0% of all menagerie composure
- Menagerie composure dealt: 112803 · block generated: 44547
- Avg summons/combat: 7.04 · avg feeds/combat: 3.51
- Tactic changes: 2645 · avg distinct tactics/combat: 0.96
- Tactic engagement: shield 875 · rabid 345 · youth 435 · nurture 699 · feather 291
...
- v2.92 Passing Thoughts: 287 granted, 0 played
...
## Top killer enemies
- e2-boss-tapestry (The Tapestry Walker): 145
- e3-vein-devourer (Vein Devourer): 39
- e2-pattern-maker (The Pattern-Maker): 26
- e2-silent-spinner (The Silent Spinner): 25
- e3-quartz-sentinel (Quartz Sentinel): 20
- e3-boss-anvil (The Anvil-Forged): 19
- e2-silk-wraith (Silk Wraith): 15
- e3-glow-mite (Glow Mite Swarm): 8
