...
## Win rate
- **1 wins / 20** = **5.0%**
- Losses by acts-cleared: 0=15 · 1=3 · 2=1 · 3=0
...
- **fam-toad**: 4 runs · 0 wins (0.0%)
- **fam-beetle**: 3 runs · 0 wins (0.0%)
- **fam-cat**: 1 runs · 0 wins (0.0%)
- **fam-hedgehog**: 5 runs · 0 wins (0.0%)
...
## Cast distribution
- Total casts: 171
- Tier 1 (COHERENT): 152 (88.9%)
- Tier 2 (RESONANT): 19 (11.1%)
- Tier 3 (DEVASTATING): 0 (0.0%)
- Holds (turn ended without cast — tray persists): 696 (80.3%)
...
- Combats reaching LT ≥ 1: 40 (runs: 20 / 20, 100.0%)
- Avg peak LT per run (across all combats): 2.50
- Avg peak LT per threaded combat: 1.25
- Thread breaks (unblocked hit reset a non-zero meter): 38
...
- v2.92 Passing Thoughts: 19 granted, 18 played
- v2.93 Find the Seam (bypass-effectiveness) fires: 1
...
## Wit FOOTNOTE (v2.35)
- Footnotes applied: 2 (runs: 2 / 20, 10.0%)
- Casts contributing footnote bonus: 1
- Total footnote bonus damage: 2
- Avg bonus per footnoted cast: 2.00

## Wit ACTUALLY— (v2.36)
- Re-fires resolved: 14 (runs: 3 / 20, 15.0%)
- Total re-fire damage: 171
- Avg damage / re-fire: 12.21
- Enemy bonus from arguing-back: 7 (cost side fired)
...
- Casts that queued a Misstep: 19 (runs: 3 / 20, 15.0%)
- Up-front damage dealt by those casts: 498
- Tokens delivered to hand: 4
- Discarded (1 Energy paid): 2
- Auto-played (-3 HP eaten): 2 (total damage: 6)
- KOs by Misstep auto-play: 0
- Avg up-front damage / cast: 26.21

## Wit OPENING STATEMENT (v2.39)
- Bonus triggers: 2 (runs: 2 / 20, 10.0%)
- Total bonus damage: 8
- Avg bonus / trigger: 4.00
- Revisit-opening skill plays: 0

## Wit PATIENCE (v2.40)
- Installs: 39 (runs: 10 / 20, 50.0%)
- Peak stacks — max: 30, mean: 9.00
- Total damage from patience-spend: 228
- Casts that consumed bank: 46
- "I'll let you finish," skill plays: 1
- Avg damage / spend: 4.96

## Wit SYNERGY CAPSTONE (v2.41)
- "in summary," casts: 2 (runs: 2 / 20, 10.0%)
- Total capstone damage: 54
- Avg damage per cast: 27.00
...
## Combat pacing
- Avg turns / combat: 9.26
- Avg damage / run: 42
- Mean final deck size: 6.4

## Archetype of winning decks
- mid-t2t3: 1

## Top killer enemies
- e2-boss-tapestry (The Tapestry Walker): 8
