...
## Win rate
- **0 wins / 30** = **0.0%**
- Losses by acts-cleared: 0=30 · 1=0 · 2=0 · 3=0
...
## Cast distribution
- Total casts: 185
- Tier 1 (COHERENT): 178 (96.2%)
- Tier 2 (RESONANT): 7 (3.8%)
- Tier 3 (DEVASTATING): 0 (0.0%)
- Holds (turn ended without cast — tray persists): 882 (82.7%)
...
- Combats reaching LT ≥ 1: 44 (runs: 24 / 30, 80.0%)
- Avg peak LT per run (across all combats): 1.73
- Avg peak LT per threaded combat: 1.18
- Thread breaks (unblocked hit reset a non-zero meter): 31
...
- v2.92 Passing Thoughts: 15 granted, 17 played
...
## Wit FOOTNOTE (v2.35)
- Footnotes applied: 1 (runs: 1 / 30, 3.3%)
- Casts contributing footnote bonus: 2
- Total footnote bonus damage: 4
- Avg bonus per footnoted cast: 2.00

## Wit ACTUALLY— (v2.36)
- Re-fires resolved: 8 (runs: 4 / 30, 13.3%)
- Total re-fire damage: 56
- Avg damage / re-fire: 7.00
- Enemy bonus from arguing-back: 6 (cost side fired)
...
## Wit PATIENCE (v2.40)
- Installs: 16 (runs: 11 / 30, 36.7%)
- Peak stacks — max: 30, mean: 6.43
- Total damage from patience-spend: 160
- Casts that consumed bank: 20
- "I'll let you finish," skill plays: 2
- Avg damage / spend: 8.00

## Wit SYNERGY CAPSTONE (v2.41)
- "in summary," casts: 5 (runs: 3 / 30, 10.0%)
- Total capstone damage: 94
- Avg damage per cast: 18.80
...
## Combat pacing
- Avg turns / combat: 11.93
- Avg damage / run: 11
- Mean final deck size: 5.8

## Archetype of winning decks

## Top killer enemies
- e2-boss-tapestry (The Tapestry Walker): 6
- e2-hollow-weaver (Hollow Weaver): 6
- e2-silk-wraith (Silk Wraith): 6
- e2-loom-familiar (Loom Familiar): 5
