...
## Win rate
- **0 wins / 100** = **0.0%**
- Losses by acts-cleared: 0=72 · 1=26 · 2=2 · 3=0
...
- **fam-hedgehog**: 14 runs · 0 wins (0.0%)
- **fam-snake**: 14 runs · 0 wins (0.0%)
- **fam-crow**: 8 runs · 0 wins (0.0%)
- **fam-rabbit**: 13 runs · 0 wins (0.0%)
- **fam-mouse**: 13 runs · 0 wins (0.0%)
- **fam-toad**: 9 runs · 0 wins (0.0%)
- **fam-cat**: 6 runs · 0 wins (0.0%)
- **fam-raven**: 9 runs · 0 wins (0.0%)
- **fam-owl**: 6 runs · 0 wins (0.0%)

## Cast distribution
- Total casts: 918
- Tier 1 (COHERENT): 816 (88.9%)
- Tier 2 (RESONANT): 100 (10.9%)
- Tier 3 (DEVASTATING): 2 (0.2%)
- Holds (turn ended without cast — tray persists): 2420 (72.5%)

## Chutzpah TUNNEL VISION (v2.24)
- Total RAGE triggers: 0
- Runs with at least one RAGE turn: 0 / 100 (0.0%)
- Bare Knuckles casts: 0 (misfires: 0)

## Chutzpah DOUBLING DOWN (v2.25)
- Total double-down casts: 0
- Runs with at least one double-down cast: 0 / 100 (0.0%)
...
- Runs with at least one Storm Out: 0 / 100 (0.0%)

## Chutzpah HIT ME AGAIN (v2.27)
- Hit Me Again installs: 0 (runs: 0 / 100, 0.0%)
...
- Combats reaching LT ≥ 1: 199 (runs: 91 / 100, 91.0%)
- Avg peak LT per run (across all combats): 2.15
- Avg peak LT per threaded combat: 1.08
- Thread breaks (unblocked hit reset a non-zero meter): 141
- Thread-scaling rider triggers: 4
- Total bonus damage from thread scaling: 16
...
- v2.92 Passing Thoughts: 61 granted, 61 played
- v2.93 Find the Seam (bypass-effectiveness) fires: 2
- v2.93 Precedent (echo-last-damage) fires: 3
...
## Wit FOOTNOTE (v2.35)
- Footnotes applied: 10 (runs: 10 / 100, 10.0%)
- Casts contributing footnote bonus: 37
- Total footnote bonus damage: 124
- Avg bonus per footnoted cast: 3.35

## Wit ACTUALLY— (v2.36)
- Re-fires resolved: 37 (runs: 19 / 100, 19.0%)
- Total re-fire damage: 805
- Avg damage / re-fire: 21.76
- Enemy bonus from arguing-back: 10 (cost side fired)

## Wit HOLD ON — (v2.37)
- Plays: 9 (runs: 9 / 100, 9.0%)
- Total damage prevented: 9
- Avg prevention / play: 1.00

## Wit SAYING SOMETHING WRONG (v2.38)
- Casts that queued a Misstep: 92 (runs: 32 / 100, 32.0%)
- Up-front damage dealt by those casts: 2583
- Tokens delivered to hand: 28
- Discarded (1 Energy paid): 1
- Auto-played (-3 HP eaten): 26 (total damage: 78)
- KOs by Misstep auto-play: 0
- Avg up-front damage / cast: 28.08

## Wit OPENING STATEMENT (v2.39)
- Bonus triggers: 10 (runs: 5 / 100, 5.0%)
- Total bonus damage: 41
- Avg bonus / trigger: 4.10
- Revisit-opening skill plays: 8

## Wit PATIENCE (v2.40)
- Installs: 180 (runs: 45 / 100, 45.0%)
- Peak stacks — max: 30, mean: 2.32
- Total damage from patience-spend: 972
- Casts that consumed bank: 252
- "I'll let you finish," skill plays: 11
- Avg damage / spend: 3.86

## Wit SYNERGY CAPSTONE (v2.41)
- "in summary," casts: 31 (runs: 14 / 100, 14.0%)
- Total capstone damage: 682
- Avg damage per cast: 22.00

## Wit INSULT VULNERABILITIES (v2.42)
- Casts that hit the rider: 13 (runs: 7 / 100, 7.0%)
- Total matched tags (capped 3/cast): 17
- Total bonus damage: 68
- Avg bonus per cast: 5.23
...
- Avg damage / run: 134
- Mean final deck size: 8.8

## Archetype of winning decks

## Top killer enemies
- e2-boss-tapestry (The Tapestry Walker): 19
- e2-loom-familiar (Loom Familiar): 13
- e2-silent-spinner (The Silent Spinner): 12
- e2-hollow-weaver (Hollow Weaver): 10
...
- e3-vein-devourer (Vein Devourer): 5
