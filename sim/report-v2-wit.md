...
## Win rate
- **0 wins / 100** = **0.0%**
- Losses by acts-cleared: 0=82 · 1=18 · 2=0 · 3=0
...
- **fam-beetle**: 13 runs · 0 wins (0.0%)
- **fam-rabbit**: 14 runs · 0 wins (0.0%)
...
- **fam-owl**: 14 runs · 0 wins (0.0%)
- **fam-raven**: 6 runs · 0 wins (0.0%)
- **fam-snake**: 4 runs · 0 wins (0.0%)

## Cast distribution
- Total casts: 1086
- Tier 1 (COHERENT): 869 (80.0%)
- Tier 2 (RESONANT): 212 (19.5%)
- Tier 3 (DEVASTATING): 5 (0.5%)
- Holds (turn ended without cast — tray persists): 3064 (73.8%)
...
- Full FFT casts: 811 (total FFT damage 9541) · partial-row: 248 · same-school (non-row): 7
- Slow Burn DoT deposited: 4419
- Crescendo bank cash-ins (flat damage): 4758
- Thorns block granted by casts: 711
- Thorns BODY SLAM: 6 casts · 22 damage

## Wit LONG THREAD (v2.34)
- Combats reaching LT ≥ 1: 285 (runs: 97 / 100, 97.0%)
- Avg peak LT per run (across all combats): 4.36
- Avg peak LT per threaded combat: 1.53
- Thread breaks (unblocked hit reset a non-zero meter): 289
- Thread-scaling rider triggers: 14
- Total bonus damage from thread scaling: 104
...
- v2.92 Passing Thoughts: 59 granted, 57 played
...
## Wit FOOTNOTE (v2.35)
- Footnotes applied: 8 (runs: 8 / 100, 8.0%)
- Casts contributing footnote bonus: 20
- Total footnote bonus damage: 54
- Avg bonus per footnoted cast: 2.70

## Wit ACTUALLY— (v2.36)
- Re-fires resolved: 68 (runs: 21 / 100, 21.0%)
- Total re-fire damage: 1066
- Avg damage / re-fire: 15.68
- Enemy bonus from arguing-back: 38 (cost side fired)

## Wit HOLD ON — (v2.37)
- Plays: 17 (runs: 10 / 100, 10.0%)
- Total damage prevented: 31
- Avg prevention / play: 1.82

## Wit SAYING SOMETHING WRONG (v2.38)
- Casts that queued a Misstep: 115 (runs: 28 / 100, 28.0%)
- Up-front damage dealt by those casts: 1447
- Tokens delivered to hand: 74
- Discarded (1 Energy paid): 71
- Auto-played (-3 HP eaten): 3 (total damage: 9)
- KOs by Misstep auto-play: 0
- Avg up-front damage / cast: 12.58
...
- "in summary," casts: 53 (runs: 15 / 100, 15.0%)
...
## Combat pacing
- Avg turns / combat: 10.72
- Avg damage / run: 114
- Mean final deck size: 5.4

## Archetype of winning decks

## Top killer enemies
- e2-boss-tapestry (The Tapestry Walker): 23
- e2-silent-spinner (The Silent Spinner): 17
- weave: 7
- e2-silk-wraith (Silk Wraith): 7
- e2-patchwork-golem (Patchwork Golem): 6
- e3-geode-crab (Geode Crab): 5
- e3-vein-devourer (Vein Devourer): 4
- e2-spindlewight (Spindlewight): 4
- e2-gauze-revenant (The Gauze Revenant): 3
- e2-loom-familiar (Loom Familiar): 3
- e2-moth-choir (The Moth Choir): 3
- e3-boss-anvil (The Anvil-Forged): 2
- e2-lint-sprite (Lint Sprite): 2
