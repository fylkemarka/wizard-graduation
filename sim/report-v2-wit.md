...
## Win rate
- **0 wins / 60** = **0.0%**
- Losses by acts-cleared: 0=47 · 1=13 · 2=0 · 3=0

## Lane outcomes
- **wit**: 60 runs · 0 wins (0.0%)
...
## Cast distribution
- Total casts: 1133
- Tier 1 (COHERENT): 752 (66.4%)
- Tier 2 (RESONANT): 379 (33.5%)
- Tier 3 (DEVASTATING): 2 (0.2%)
- Holds (turn ended without cast — tray persists): 1236 (52.2%)
...
- Full FFT casts: 419 (total FFT damage 10699) · partial-row: 489 · same-school (non-row): 64
- Slow Burn DoT deposited: 0
- Crescendo bank cash-ins (flat damage): 7966
- Thorns block granted by casts: 0
- Thorns BODY SLAM: 0 casts · 0 damage
- Slot-tutor skills: 28 plays · 28 cards pulled
- Hold causes: full-tray(deliberate/energy-at-cast) 0 · energy-short 358 · missing-slot 878 (intro 136 / subject 441 / target 420)

## Wit LONG THREAD (v2.34)
- Combats reaching LT ≥ 1: 250 (runs: 60 / 60, 100.0%)
- Avg peak LT per run (across all combats): 5.10
- Avg peak LT per threaded combat: 1.22
- Thread breaks (unblocked hit reset a non-zero meter): 307
...
- v2.92 Passing Thoughts: 47 granted, 46 played
- v2.93 Find the Seam (bypass-effectiveness) fires: 4
...
## Combat pacing
- Avg turns / combat: 8.03
- Avg damage / run: 282
- Mean final deck size: 8.0
