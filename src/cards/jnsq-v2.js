...
const INTROS = [
  ...
  // ---- Uncommon (6) ----
  { id: 'jv2-i-seventh-nothing', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-i-momentary-tangent', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-i-read-in-dream', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-i-horse-knows', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-i-dont-ask-how-i-know', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-i-three-tuesdays-locally', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
...
const SUBJECTS = [
  ...
  // ---- Uncommon (6) ----
  { id: 'jv2-s-small-dog', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-s-slow-song-subconscious', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-s-patient-stupidity', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-s-seven-curtains', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-s-fate-wrong-invoice', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'jv2-s-not-having-yet', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
...
const TARGETS = [
  ...
  { id: 'jv2-t-forgotten-name', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'jnsq', base: 5, multiplier: 3, damageType: 'composure' },
