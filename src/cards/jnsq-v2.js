...
const TARGETS = [
  // ---- Common (5) ----
  { id: 'jv2-t-wrong-color', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 2, type: 'effect',
  ...
  { id: 'jv2-t-owes-nothing', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 2, type: 'effect',
  ...
  { id: 'jv2-t-forgotten-name', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 2, type: 'effect',
  ...
  { id: 'jv2-t-levitating', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 2, type: 'effect',
  ...
  { id: 'jv2-t-not-from-here', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 2, type: 'effect',
