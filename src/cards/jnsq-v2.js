...
const INTROS = [
  ...
  // ---- Rare (2) ----
  { id: 'jv2-i-kitchen-sacred', slot: 'intro', tier: 3, rarity: 'rare', lane: LANE, cost: 2, type: 'word',
  ...
  { id: 'jv2-i-moon-disagrees', slot: 'intro', tier: 3, rarity: 'rare', lane: LANE, cost: 2, type: 'word',
...
const TARGETS = [
  ...
  { id: 'jv2-t-forgotten-name', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'jnsq', base: 5, multiplier: 2, damageType: 'composure' },
  ...
  { id: 'jv2-t-levitating', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'jnsq', base: 5, multiplier: 2, damageType: 'composure', rider: { vulnerable: 1 } },
