...
const INTROS = [
  ...
  // ---- Uncommon (6) ----
  { id: 'cv2-i-now-you-listen', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-i-only-going-to-say', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-i-hold-up', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-i-wanna-know', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-i-bring-it-on', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-i-look-in-my-eyes', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
...
const SUBJECTS = [
  ...
  // ---- Uncommon (6) ----
  { id: 'cv2-s-audacity', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-s-keep-showing-up', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-s-basic-respect', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-s-entire-universe', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-s-special-grade', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'cv2-s-standing-pretending', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
