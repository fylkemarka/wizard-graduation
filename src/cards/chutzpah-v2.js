...
const INTROS = [
  ...
  // ---- Rare (2) ----
  { id: 'cv2-i-dont-say-lightly', slot: 'intro', tier: 3, rarity: 'rare', lane: LANE, cost: 2, type: 'word',
  ...
  { id: 'cv2-i-comes-a-time', slot: 'intro', tier: 3, rarity: 'rare', lane: LANE, cost: 2, type: 'word',
...
const TARGETS = [
  ...
  { id: 'cv2-t-stops-now', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'chutzpah', base: 5, multiplier: 2, damageType: 'composure', rider: { weak: 1 } },
