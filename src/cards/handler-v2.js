// Handler lane v2 — The Handler's deck. (Animal Summoner pivot — see
...
const INTROS = [
  ...
  { id: 'cv2-i-okay', slot: 'intro', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    phrase: 'Okay,', tags: ['direct', 'dismissive'], stats: { handler: 1 },
    flavor: 'Not okay. Not at all. But also: okay.' },
  // v2.4: HP-cost intro (Handler HP-for-tempo identity, Ironclad-style).
  { id: 'cv2-i-be-blunt', slot: 'intro', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    phrase: "Look — I'll be blunt:", tags: ['direct', 'threatening'], stats: { handler: 2 },
    effects: { loseHp: 1 },
  ...
  { id: 'cv2-i-listen-carefully', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 2, type: 'word',
    phrase: 'Listen carefully now,', tags: ['demanding', 'threatening'], stats: { handler: 2 },
    effects: { weak: 1 },
    flavor: 'The careful is for them, not you.' },
  { id: 'cv2-i-lemme-explain', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'Lemme explain something,', tags: ['swaggering', 'direct'], stats: { handler: 2 },
  ...
  { id: 'cv2-i-once', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: "I'm gonna tell you once,", tags: ['threatening', 'demanding'], stats: { handler: 2 },
  ...
  { id: 'cv2-i-end-of-story', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'End of story,', tags: ['dismissive', 'swaggering'], stats: { handler: 2 },
  ...
  { id: 'cv2-i-straight-up', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'Straight up,', tags: ['direct', 'swaggering'], stats: { handler: 2 },
  ...
  { id: 'cv2-i-cut-the-crap', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'Cut the crap,', tags: ['dismissive', 'demanding'], stats: { handler: 2 },
  ...
  { id: 'cv2-i-period', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'Period:', tags: ['dismissive', 'threatening'], stats: { handler: 2 },
    flavor: 'The shortest sentence in handler ends in a colon.' },
  // v2.4: HP-cost common intro.
  { id: 'cv2-i-skin-game', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'Skin in the game,', tags: ['threatening', 'swaggering'], stats: { handler: 3 },
    effects: { loseHp: 2 },
    flavor: "The skin in question is yours. Both yours, really. That's the bargain." },
  // v2.24: TUNNEL VISION pump intro — Cycle 1 of the handler meter arc.
  // Heavier handler stat than a basic intro AND +2 to the rage meter.
  { id: 'cv2-i-foaming', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'Foaming at the mouth,', tags: ['threatening', 'swaggering'], stats: { handler: 3 },
  ...
  { id: 'cv2-i-now-you-listen', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'Now you listen to me, friend,', tags: ['demanding', 'threatening'], stats: { handler: 3 },
  ...
  { id: 'cv2-i-only-going-to-say', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "I'm only going to say this once:", tags: ['threatening', 'swaggering'], stats: { handler: 3 },
    flavor: 'Once is generous. Once is restraint.' },
  { id: 'cv2-i-hold-up', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'Hold up, hold up, hold up —', tags: ['demanding', 'swaggering'], stats: { handler: 3 },
  ...
  { id: 'cv2-i-wanna-know', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'You wanna know what I think?', tags: ['swaggering', 'direct'], stats: { handler: 3 },
  ...
  { id: 'cv2-i-bring-it-on', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'Bring it on, but understand —', tags: ['threatening', 'swaggering'], stats: { handler: 3 },
  ...
  { id: 'cv2-i-look-in-my-eyes', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'Look in my eyes and tell me:', tags: ['demanding', 'direct'], stats: { handler: 3 },
  ...
  { id: 'cv2-i-dont-say-lightly', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "Now I don't say this lightly, and I won't say it twice:", tags: ['threatening', 'direct', 'swaggering'], stats: { handler: 4 },
  ...
  { id: 'cv2-i-comes-a-time', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'There comes a time, see, and that time is right now:', tags: ['demanding', 'swaggering', 'threatening'], stats: { handler: 4 },
  ...
  { id: 'cv2-i-no-half-measures', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'No half measures —', tags: ['threatening', 'direct'], stats: { handler: 2 },
...
const SUBJECTS = [
  ...
  { id: 'cv2-s-this-nonsense', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    phrase: 'this nonsense', tags: ['dismissive'], stats: { handler: 1 },
  ...
  { id: 'cv2-s-your-attitude', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 2, type: 'word',
    phrase: 'your attitude', tags: ['dismissive', 'direct'], stats: { handler: 1 },
    effects: { vulnerable: 1 },
  ...
  { id: 'cv2-s-this-whole-thing', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    phrase: 'this whole thing', tags: ['dismissive'], stats: { handler: 1 },
  ...
  { id: 'cv2-s-all-of-it', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    phrase: 'all of it', tags: ['dismissive', 'demanding'], stats: { handler: 1 },
  ...
  { id: 'cv2-s-your-face', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    phrase: 'your face', tags: ['direct', 'dismissive'], stats: { handler: 1 },
  ...
  { id: 'cv2-s-your-big-talk', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'your big talk', tags: ['dismissive', 'threatening'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-charade', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'this whole charade', tags: ['dismissive', 'swaggering'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-entire-premise', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'the entire premise', tags: ['dismissive', 'direct'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-little-routine', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'your little routine', tags: ['dismissive'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-every-word', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'every word coming out of your mouth', tags: ['dismissive', 'direct'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-your-problem', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'your problem', tags: ['direct', 'demanding'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-song-and-dance', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'this whole song and dance', tags: ['dismissive', 'swaggering'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-half-baked-plan', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'your half-baked plan', tags: ['dismissive', 'threatening'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-sorry-excuse', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'your sorry excuse for an argument', tags: ['dismissive', 'threatening'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-handling-yourself', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: "the way you're handling yourself", tags: ['direct', 'threatening'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-last-five-minutes', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: "everything you've said in the last five minutes", tags: ['dismissive', 'direct'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-your-tone', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'your tone with me', tags: ['demanding', 'threatening'], stats: { handler: 2 },
  ...
  { id: 'cv2-s-your-every-breath', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'your every breath from now on', tags: ['threatening', 'demanding'], stats: { handler: 3 },
  ...
  { id: 'cv2-s-yourself-mostly', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'yourself, mostly', tags: ['dismissive', 'direct'], stats: { handler: 3 },
  ...
  { id: 'cv2-s-audacity', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'the audacity of bringing that here', tags: ['dismissive', 'threatening'], stats: { handler: 3 },
  ...
  { id: 'cv2-s-keep-showing-up', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'the way you keep showing up', tags: ['dismissive', 'threatening', 'direct'], stats: { handler: 3 },
  ...
  { id: 'cv2-s-basic-respect', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'your continued lack of basic respect', tags: ['demanding', 'dismissive'], stats: { handler: 3 },
  ...
  { id: 'cv2-s-entire-universe', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "the entire universe you've built around this", tags: ['dismissive', 'swaggering'], stats: { handler: 3 },
  ...
  { id: 'cv2-s-special-grade', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "the special grade of nonsense you've prepared", tags: ['dismissive', 'threatening'], stats: { handler: 3 },
  ...
  { id: 'cv2-s-standing-pretending', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'the way you stand there pretending', tags: ['dismissive', 'direct'], stats: { handler: 3 },
  ...
  { id: 'cv2-s-unforced-errors', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "the long, long list of unforced errors you've called a career", tags: ['dismissive', 'threatening', 'direct'], stats: { handler: 4 },
  ...
  { id: 'cv2-s-brought-you-here', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'everything that brought you to this exact moment, here, in front of me', tags: ['threatening', 'direct', 'swaggering'], stats: { handler: 4 },
...
const TARGETS = [
  ...
  { id: 'cv2-t-quit-it', slot: 'target', tier: 1, rarity: 'basic', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 4, multiplier: 3, damageType: 'composure' },
  ...
  { id: 'cv2-t-stops-now', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 5, multiplier: 3, damageType: 'composure', rider: { weak: 1 } },
    flavor: 'Now being a word that, in handler, carries actual force.' },
  { id: 'cv2-t-is-over', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    phrase: 'is over.', tags: ['demanding', 'dismissive'],
    effect: { scaleBy: 'handler', base: 7, multiplier: 3, damageType: 'composure' },
  ...
  { id: 'cv2-t-wont-fly', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 6, multiplier: 3, damageType: 'composure' },
  ...
  { id: 'cv2-t-ends-today', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 5, multiplier: 3, damageType: 'composure', drawAfterCast: 1 },
  ...
  { id: 'cv2-t-find-weather', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 7, multiplier: 3, damageType: 'composure', rider: { weak: 1 } },
  ...
  { id: 'cv2-t-find-out', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 8, multiplier: 2, damageType: 'composure', rider: { vulnerable: 1 } },
  ...
  { id: 'cv2-t-wrong-building', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 9, multiplier: 2, damageType: 'composure' },
    flavor: 'Friend, in handler, is a contranym.' },
  ...
  { id: 'cv2-t-consequences', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 9, multiplier: 2, damageType: 'composure', rider: { weak: 2 } },
  ...
  { id: 'cv2-t-bleeds-for-it', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 11, multiplier: 3, damageType: 'composure', drawAfterCast: 1, loseHpOnCast: 3 },
  ...
  { id: 'cv2-t-over-my-head', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 10, multiplier: 3, damageType: 'composure', rider: { weak: 2 } },
  ...
  { id: 'cv2-t-ted-talk', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 12, multiplier: 3, damageType: 'composure', tier3Double: true },
  ...
  { id: 'cv2-t-stops-here-ends-here', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 11, multiplier: 3, damageType: 'composure', rider: { vulnerable: 1 } },
  ...
  { id: 'cv2-t-actually-feel', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 3, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 14, multiplier: 3, damageType: 'composure',
  ...
  { id: 'cv2-t-double-or-nothing', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 5, multiplier: 3, damageType: 'composure',
              stakeMultiplier: 1.25 },
    desc: 'Cast: 5 + Handler comp. Staked HP gives +1.25 dmg/HP.',
  ...
  { id: 'cv2-t-and-i-mean-it', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    desc: 'Cast: 8 + Handler comp. If staked: heal half the stake on hit.',
  ...
  { id: 'cv2-t-big-mistake', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 18, multiplier: 3, damageType: 'composure',
              requiresStake: 8 },
    desc: 'REQUIRES 8+ HP staked. 18 + Handler comp.',
...
const MODIFIERS = [
  ...
  { id: 'cv2-m-swear-to-god', slot: 'modifier', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'modifier',
    modifierKind: 'pre', phrase: 'I swear to god,', tags: ['swaggering'], stats: { handler: 1 },
  ...
  { id: 'cv2-m-louder', slot: 'modifier', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'modifier',
    ...
    flavor: 'Volume being, in handler, a multiplier on truth.' },
...
// v2.5/2.6: SHOUTS (handler's gesture variant), PONTIFICATIONS, QUIPS.
const GESTURES = [
  ...
  // v3.0 multi-hit: HEADBUTT — handler's "shake it off" gesture. Deals
...
// v2.6: Modifiers for the new handler lane.
const NEW_MODIFIERS_V26 = [
  ...
  { id: 'cv2-m-not-even-half-kidding', slot: 'modifier', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'modifier',
    ...
    tags: ['threatening', 'direct'], stats: { handler: 1 },
...
// Handler's "I bleed, you pay" identity, mechanized.
const UNIQUE_TARGETS = [
  { id: 'cv2-t-make-me-say-it', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 8, multiplier: 2, damageType: 'composure', missingHpBonus: 0.5 },
  ...
  { id: 'cv2-t-bare-knuckles', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 12, multiplier: 4, damageType: 'composure', requiresRage: true },
    desc: 'REQUIRES RAGE. 12 + Handler×4 comp. Off-rage: half damage, exiled.',
    flavor: 'The discussion has moved past words.' },
  // v2.25: DOUBLING DOWN cards — handler's consequence-stack mechanic.
  ...
  { id: 'cv2-t-blinks-first', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 6, multiplier: 3, damageType: 'composure', doubleDown: true },
    desc: 'Cast: 6 + Handler×3 comp. DOUBLE DOWN: +1 corner token. If enemy survives the turn, -2 HP.',
  ...
  { id: 'cv2-t-last-word', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 10, multiplier: 4, damageType: 'composure', doubleDown: true, rider: { weak: 1 } },
    desc: 'Cast: 10 + Handler×4 comp · Weak 1. DOUBLE DOWN: +1 corner token. If enemy survives the turn, -2 HP.',
    flavor: 'Last words being a category that tends to multiply, in handler.' },
  // v2.26: STORMING OUT — handler's commit-and-flee finisher. Cast burns
  ...
  { id: 'cv2-t-last-problem', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'effect',
    ...
    desc: 'STORM OUT. Cast: 8 + Handler×3 + 5/Energy. Burns all energy, ends turn, enemy intent hidden.',
    flavor: "After this one, I'm leaving. Briefly. You won't see me go." },
];

// v2.29: SAYING IT LOUDER — repetition scaling. Each handler word card
...
const SAYING_IT_LOUDER_CARDS = [
  { id: 'cv2-i-i-said', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'I said,', tags: ['demanding', 'direct'], stats: { handler: 2 },
  ...
  { id: 'cv2-t-i-said-loud', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    desc: 'Cast: 6 + Handler×3 comp · Weak 1. +3 dmg per demanding handler word played this turn.',
...
// Weak/Vuln per combat AND granted +1 Block per handler cast. The on-cast
...
// v2.95: STARTER CARDS — handler-flavored "lane identity from turn 1"
...
// v2.27: HIT ME AGAIN — handler's reactive power. Cost 1, installs on the
...
// handler's true defensive identity (absorb hits and bill the enemy for
...
// on stage (setting up the predator condition AND pumping handler stat), and
...
const SMELL_WEAKNESS_CARDS = [
  { id: 'cv2-s-blood-in-water', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 2, type: 'word',
    phrase: 'smells like blood in the water,', tags: ['threatening', 'dismissive'], stats: { handler: 2 },
    effects: { vulnerable: 1 },
  ...
  { id: 'cv2-t-comes-apart', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 7, multiplier: 3, damageType: 'composure', predator: 6 },
    desc: 'Cast: 7 + Handler×3 comp. PREDATOR: +6 dmg if the enemy is Vulnerable or Weak.',
...
// handler primitives into one triple-rider rare. doubleDown banks a corner
...
const SYNERGY_CAPSTONE_CARDS = [
  { id: 'cv2-t-and-im-not-done', slot: 'target', tier: 2, rarity: 'uncommon', lane: LANE, cost: 2, type: 'effect',
    ...
    effect: { scaleBy: 'handler', base: 10, multiplier: 3, damageType: 'composure',
              doubleDown: true, loudScaling: true, predator: 4 },
    desc: 'Cast: 10 + Handler×3 comp. DOUBLE DOWN (+corner token), LOUDER (+3/demanding), PREDATOR (+4 if debuffed).',
...
// =============================================================================
// FFT ROW CARDS — REMOVED 2026-05-31. Handler pivoted away from the FFT
...
export const HANDLER_V2 = [...MODIFIERS, ...NEW_MODIFIERS_V26, ...GESTURES, ...HIT_ME_AGAIN_POWER, ...SYNERGY_CAPSTONE_MODIFIERS, ...NOT_LISTENING_SKILL_ABSORB, ...NOT_LISTENING_SKILL, ...STARTER_CARDS, ...LURE_CARDS];
