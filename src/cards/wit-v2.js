...
const INTROS = [
  ...
  { id: 'wv2-i-reasonable-observer', slot: 'intro', tier: 3, rarity: 'rare', lane: LANE, cost: 2, type: 'word',
  ...
  { id: 'wv2-i-full-possession', slot: 'intro', tier: 3, rarity: 'rare', lane: LANE, cost: 2, type: 'word',
