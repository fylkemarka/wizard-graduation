...
const INTROS = [
  ...
  { id: 'wv2-i-permit-me-observe', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-charitable', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-setting-aside', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-if-records-trusted', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
    phrase: 'If the records can be trusted,', tags: ['academic', 'ironic'], stats: { wit: 3 },
    flavor: 'They can. That is, in fact, the worst part.' },
  { id: 'wv2-i-put-generously', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
    phrase: 'To put it generously,', tags: ['ironic', 'dismissive'], stats: { wit: 3 },
    flavor: 'Generosity, here, is an act of restraint. Witnessed.' },
  { id: 'wv2-i-purely-analytical', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
...
const SUBJECTS = [
  ...
  // ---- Uncommon (6) ----
  { id: 'wv2-s-elaborate-edifice', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-s-studied-opacity', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-s-quietly-imported', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-s-passes-for-rigor', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-s-breathtaking-confidence', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-s-unexamined-certainty', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 0, type: 'word',
