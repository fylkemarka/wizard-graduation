...
const INTROS = [
  ...
  { id: 'wv2-i-truly', schoolId: 'thorns', slot: 'intro', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-strikes-me', schoolId: 'thorns', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-by-any-measure', schoolId: 'thorns', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-it-would-appear', schoolId: 'thorns', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-being-honest', schoolId: 'crescendo', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: "If we're being honest,", tags: ['cutting'], stats: { wit: 1 },
    effects: { draw: 1, loseHp: 1 },
    flavor: 'The we is presumptuous. It always is.' },
  { id: 'wv2-i-one-could-argue', schoolId: 'crescendo', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    phrase: 'One could argue that', tags: ['academic', 'observational'], stats: { wit: 1 },
    flavor: "One could. One won't have to." },
  { id: 'wv2-i-let-the-record', schoolId: 'crescendo', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-as-i-was-saying', schoolId: 'crescendo', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
  ...
  { id: 'wv2-i-charitable', schoolId: 'thorns', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-i-if-records-trusted', schoolId: 'crescendo', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-i-put-generously', schoolId: 'thorns', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-i-purely-analytical', schoolId: 'crescendo', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
...
const SUBJECTS = [
  // ---- Basic (5) ----
  { id: 'wv2-s-your-reasoning', schoolId: 'crescendo', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-this-argument', schoolId: 'crescendo', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-your-conclusion', schoolId: 'thorns', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 1, type: 'word',
    phrase: 'your conclusion', tags: ['academic', 'cutting'], stats: { wit: 1 },
    flavor: "The conclusion is the part that didn't survive the road." },
  { id: 'wv2-s-your-sources', schoolId: 'slowburn', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 2, type: 'word',
  ...
  { id: 'wv2-s-the-matter', schoolId: 'slowburn', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 1, type: 'word',
    phrase: 'the matter at hand', tags: ['observational'], stats: { wit: 1 },
    flavor: 'The matter has been at hand for some time. It is patient.' },

  // ---- Common (12) ----
  { id: 'wv2-s-your-dissertation', schoolId: 'thorns', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
    phrase: 'your dissertation', tags: ['academic', 'cutting'], stats: { wit: 1 },
    flavor: 'Bound, defended, and from this distance — undamaged.' },
  { id: 'wv2-s-this-entire-enterprise', schoolId: 'thorns', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-the-very-premise', schoolId: 'thorns', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-your-standards', schoolId: 'thorns', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-sheer-academic', schoolId: 'crescendo', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-your-hidden-defenses', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-the-syllabus', schoolId: 'crescendo', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
    phrase: 'the syllabus', tags: ['academic', 'cutting'], stats: { wit: 1 },
    effects: { draw: 1 },
    flavor: 'A reading list, in the older and more honest sense.' },
  { id: 'wv2-s-the-bibliography', schoolId: 'crescendo', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-your-central-thesis', schoolId: 'thorns', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-foundation', schoolId: 'crescendo', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-your-methodology', schoolId: 'crescendo', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
    phrase: 'your methodology', tags: ['academic'], stats: { wit: 1 },
    flavor: 'Method, ology, and the silence between them.' },
  { id: 'wv2-s-so-called-proof', schoolId: 'crescendo', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-conclusions-drawn', schoolId: 'crescendo', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
  ...
  // ---- Uncommon (6) ----
  { id: 'wv2-s-elaborate-edifice', schoolId: 'crescendo', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-studied-opacity', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-quietly-imported', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-passes-for-rigor', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-breathtaking-confidence', schoolId: 'slowburn', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-unexamined-certainty', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-your-cuff', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-standards-of-upkeep', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-wool-spring', schoolId: 'slowburn', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: 'your wool, in spring,', tags: ['observational'], stats: { wit: 2 },
    flavor: 'Wool, in spring, being a sartorial cry for help.' },
  { id: 'wv2-s-hem-garment', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-evening-regimen', schoolId: 'crescendo', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-post-meal-ritual', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-roundabout', schoolId: 'crescendo', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-speed-limit', schoolId: 'crescendo', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
  ...
  { id: 'wv2-s-four-way-stop', schoolId: 'thorns', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
...
const TARGETS = [
  ...
  { id: 'wv2-t-what-i-expected', schoolId: 'slowburn', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
  ...
  { id: 'wv2-t-not-survive-scrutiny', schoolId: 'slowburn', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
  ...
  { id: 'wv2-t-politely-overlooked', schoolId: 'crescendo', slot: 'target', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'effect',
...
const INSULT_VULN_CARDS = [
  ...
  { id: 'wv2-s-manner-of-speaking', schoolId: 'slowburn', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
...
const BUFF_CARDS = [
  ...
  { id: 'wv2-k-enhanced-reasoning', slot: 'skill', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'skill',
    ...
    tags: ['academic'],
    effects: { boostThornsReflect: 2, exhaust: true },
