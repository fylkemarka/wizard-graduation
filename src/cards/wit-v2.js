...
const INTROS = [
  ...
  { id: 'wv2-i-frankly', slot: 'intro', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    ...
    setId: 'slowburn-4', setSlot: 'intro', tierId: 'slowburn',
  ...
  { id: 'wv2-i-actually', slot: 'intro', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    ...
    effects: { draw: 1 },
    setId: 'crescendo-4', setSlot: 'intro', tierId: 'crescendo',
  ...
  { id: 'wv2-i-honestly', slot: 'intro', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    ...
    effects: { block: 2 },
    setId: 'crescendo-5', setSlot: 'intro', tierId: 'crescendo',
  ...
  { id: 'wv2-i-curiously', slot: 'intro', tier: 1, rarity: 'basic', lane: LANE, cost: 0, type: 'word',
    ...
    setId: 'thorns-5', setSlot: 'intro', tierId: 'thorns',
  ...
  { id: 'wv2-i-i-should-think', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    ...
    setId: 'crescendo-3', setSlot: 'intro', tierId: 'crescendo',
  ...
  { id: 'wv2-i-pardon-saying', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    ...
    setId: 'thorns-2', setSlot: 'intro', tierId: 'thorns',
  ...
  { id: 'wv2-i-strictly-speaking', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    ...
    effects: { weak: 1 },
    setId: 'crescendo-2', setSlot: 'intro', tierId: 'crescendo',
  ...
  { id: 'wv2-i-memory-serves', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    ...
    setId: 'slowburn-8', setSlot: 'intro', tierId: 'slowburn',
  ...
  { id: 'wv2-i-speaking-plainly', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    ...
    setId: 'slowburn-5', setSlot: 'intro', tierId: 'slowburn',
  ...
  { id: 'wv2-i-or-rather', slot: 'intro', tier: 1, rarity: 'common', lane: LANE, cost: 0, type: 'word',
    ...
    effects: { draw: 1 },
    setId: 'thorns-3', setSlot: 'intro', tierId: 'thorns',
  ...
  { id: 'wv2-i-permit-me-observe', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    ...
    setId: 'slowburn-2', setSlot: 'intro', tierId: 'slowburn',
  ...
  { id: 'wv2-i-setting-aside', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    ...
    setId: 'thorns-6', setSlot: 'intro', tierId: 'thorns',
  ...
  { id: 'wv2-i-fabric-merchant', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "Over time,", tags: ['observational', 'academic'], stats: { wit: 3 },
    setId: 'slowburn-1', setSlot: 'intro', tierId: 'slowburn',
  ...
  { id: 'wv2-i-specifically-speaking', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    ...
    setId: 'thorns-1', setSlot: 'intro', tierId: 'thorns',
  ...
  { id: 'wv2-i-civically-speaking', slot: 'intro', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "When you add it up,", tags: ['academic', 'observational'], stats: { wit: 3 },
    setId: 'crescendo-1', setSlot: 'intro', tierId: 'crescendo',
...
const SUBJECTS = [
  ...
  { id: 'wv2-s-your-taste', slot: 'subject', tier: 1, rarity: 'common', lane: LANE, cost: 1, type: 'word',
    phrase: "your argument", tags: ['observational', 'cutting'], stats: { wit: 2 },
    effects: { vulnerable: 1 },
    setId: 'slowburn-1', setSlot: 'subject', tierId: 'slowburn',
  ...
  { id: 'wv2-s-boucle-starter', slot: 'subject', tier: 1, rarity: 'basic', lane: LANE, cost: 1, type: 'word',
    ...
    setId: 'slowburn-4', setSlot: 'subject', tierId: 'slowburn',
  ...
  { id: 'wv2-s-gentleman-bidet', slot: 'subject', tier: 3, rarity: 'rare', lane: LANE, cost: 1, type: 'word',
    phrase: "your next attack", tags: ['observational', 'cutting'], stats: { wit: 4 },
    setId: 'thorns-1', setSlot: 'subject', tierId: 'thorns',
  ...
  { id: 'wv2-s-turn-signal', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "every word so far", tags: ['academic', 'observational'], stats: { wit: 3 },
    setId: 'crescendo-1', setSlot: 'subject', tierId: 'crescendo',
  ...
  { id: 'wv2-s-linen-october', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "your reasoning", tags: ['observational', 'cutting'], stats: { wit: 3 },
    setId: 'slowburn-2', setSlot: 'subject', tierId: 'slowburn',
  ...
  { id: 'wv2-s-dry-shaving', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "every blow you throw", tags: ['observational', 'cutting'], stats: { wit: 3 },
    setId: 'thorns-2', setSlot: 'subject', tierId: 'thorns',
  ...
  { id: 'wv2-s-dental-schedule', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "your aggression", tags: ['academic', 'observational'], stats: { wit: 3 },
    setId: 'thorns-3', setSlot: 'subject', tierId: 'thorns',
  ...
  { id: 'wv2-s-yield-sign', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "this argument", tags: ['academic', 'observational'], stats: { wit: 3 },
    setId: 'crescendo-2', setSlot: 'subject', tierId: 'crescendo',
  ...
  { id: 'wv2-s-your-volvo', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "what's been building", tags: ['observational', 'academic'], stats: { wit: 3 },
    setId: 'crescendo-3', setSlot: 'subject', tierId: 'crescendo',
  ...
  { id: 'wv2-s-boucle-suggestion', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "your point", tags: ['observational'], stats: { wit: 3 },
    setId: 'slowburn-4', setSlot: 'subject', tierId: 'slowburn',
    flavor: 'A suggestion that, mercifully, can be revoked.' },
  { id: 'wv2-s-evening-wear', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "your premise", tags: ['observational', 'academic'], stats: { wit: 3 },
    setId: 'slowburn-5', setSlot: 'subject', tierId: 'slowburn',
  ...
  { id: 'wv2-s-towel-rotation', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "what you throw", tags: ['observational', 'cutting'], stats: { wit: 3 },
    setId: 'thorns-5', setSlot: 'subject', tierId: 'thorns',
  ...
  { id: 'wv2-s-parallel-parking', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "every point we've made", tags: ['observational'], stats: { wit: 3 },
    setId: 'crescendo-4', setSlot: 'subject', tierId: 'crescendo',
  ...
  { id: 'wv2-s-left-lane-behavior', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "the case I've laid out", tags: ['academic', 'cutting'], stats: { wit: 3 },
    setId: 'crescendo-5', setSlot: 'subject', tierId: 'crescendo',
  ...
  { id: 'wv2-s-silk-before-8', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "your conclusion", tags: ['academic'], stats: { wit: 3 },
    setId: 'slowburn-8', setSlot: 'subject', tierId: 'slowburn',
  ...
  { id: 'wv2-s-bathroom-door', slot: 'subject', tier: 2, rarity: 'uncommon', lane: LANE, cost: 1, type: 'word',
    phrase: "your next move", tags: ['observational', 'cutting'], stats: { wit: 3 },
    setId: 'thorns-6', setSlot: 'subject', tierId: 'thorns',
