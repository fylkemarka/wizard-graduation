...
export const WIT_ROWS = [
  ...
  // → stack DoT → finish with multiply or consume burst.
  {
    ...
    riderDesc: 'DoT 2 damage/turn × 8 turns. The long, thin burn.',
  },
  {
    ...
    riderDesc: 'DoT 5, 4, 3, 2, 1 damage across 5 turns. Front-loaded.',
  },
  {
    ...
    riderDesc: 'DoT 3 damage/turn × 3 turns. The school\'s clean opener.',
  },
  {
    ...
    riderDesc: 'DoT 1, 3, 6, 8 damage across 4 turns. Ramping payoff.',
  },
  {
    ...
    riderDesc: 'DoT 3 damage/turn × 4 turns AND Vulnerable 1× each turn × 3.',
  },
  ...
  },
  {
    ...
    riderDesc: 'DoT 8, 6, 5, 4, 3 damage across 5 turns (26 total) AND Vulnerable 1× each turn × 2. The verdict, delivered slowly.',
  },
  {
