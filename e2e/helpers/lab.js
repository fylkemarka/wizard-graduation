...
export async function gotoLab(page, lane, { seed, forceSwoop, forceMaul, forceSalmonRoll, forceSpecies, forcePhaseShift, forceIntentKind } = {}) {
  ...
  if (forcePhaseShift) params.set('forcePhaseShift', '1');
  if (forceIntentKind) params.set('forceIntentKind', forceIntentKind);
